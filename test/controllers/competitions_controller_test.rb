...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference("Competition.count") do
      post competitions_url, params: { competition: { competition_name: @competition.competition_name, country: @competition.country, date: @competition.date, distance_type: @competition.distance_type, location: @competition.location } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { competition_name: @competition.competition_name, country: @competition.country, date: @competition.date, distance_type: @competition.distance_type, location: @competition.location } }
